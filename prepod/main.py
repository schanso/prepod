...
regions = ['frontal', 'fronto-parietal', 'parietal', 'central', 'occipital']
freq_bands = ['slow', 'alpha', 'beta', 'delta', 'theta']
bis_crits = [50, 40, 30]
study = 'Sudocu'
test_size = .5
n_leave_out = 2
...
for region in regions:
    ...
    for freq_band in freq_bands:
        ...
        try:
            ...
            _data = prep.merge_subjects(datasets, path_out=path_out_merged)
            ...
            for use_from in use_froms:
                for use_min in use_mins:
                    ...
                    cols = ['date', 'mean_lda', 'std_lda', 'mean_svm', 'std_svm', 'region', 'freq_band',
                            ...
                            'use_min', 'use_from', 'below_500_lda', 'below_500_svm']
